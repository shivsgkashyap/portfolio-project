...
const Projects = ({ projects }: Props) => {
  return (
    <div className="h-screen relative flex overflow-hidden flex-col text-left max-w-full justify-center mx-auto items-center z-0">
      ...
      <div className="relative w-full items-center flex overflow-x-scroll overflow-y-hidden snap-x snap-mandatory z-20 scrollbar scrollbar-track-gray-400/20 scrollbar-thumb-[#F7AB0A]/80">
        {projects?.map((project) => (
          <motion.div
            ...
            className="w-screen h-screen flex-shrink-0 snap-center flex flex-col space-y-5 items-center justify-center md:space-y-10 lg:justify-start lg:mt-20 2xl:justify-center 2xl:mt-0"
            key={project._id}
          >
            <motion.img
              initial={{
